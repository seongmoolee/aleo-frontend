...
import "./App.css";
import hello_leo3944123 from "../hello_leo3944123/build/main.aleo?raw";
...
function App() {
  ...
  async function deploy() {
    setDeploying(true);
    try {
      const result = await aleoWorker.deployProgram(hello_leo3944123);
